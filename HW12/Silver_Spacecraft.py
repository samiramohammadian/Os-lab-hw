...
class Game(arcade.Window):
    ...
    def on_draw(self):
        arcade.start_render()
        if self.me.health<=0:
            arcade.draw_text('GAME OVER', self.w//2-200, self.h//2, arcade.color.RED, DEFAULT_FONT_SIZE , width=400, align='center')
        else:
